...
var readCard = $(".card-link").click(function(){
...
//display the movie name in card(both user account and homepage html)
var movieName = $(".title")

//display the movie rating in card(both user account and homepage html)
var movieRating = $(".rating")

//display the movie length in card(both user account and homepage html)
var movieLength = $(".length")
